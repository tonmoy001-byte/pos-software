  ...
  const plans = [
    ...
    },
    {
      ...
      features: JSON.stringify([
        "pos", "inventory", "customers", "emi_tracking",
        "basic_reports", "single_branch", "backup_restore", "email_support",
      ]),
    },
    {
      name: "pro",
      ...
      features: JSON.stringify([
        "pos", "inventory", "customers", "emi_tracking",
        "advanced_reports", "multi_branch", "backup_restore",
        "priority_support", "purchase_management", "expense_management",
      ]),
    },
  ];
