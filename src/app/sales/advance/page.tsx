      ...
      <div className="w-[500px] bg-surface border-l border-border flex flex-col card-shadow">
            ...
            <div key={item.productId} className="p-4 bg-background rounded-xl border border-border space-y-3">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <button onClick={() => { const newPrice = prompt("Enter new price:", item.price.toString()); if (newPrice && !isNaN(Number(newPrice))) { setCart(cart.map(c => c.productId === item.productId ? { ...c, price: Number(newPrice) } : c)); } }} className="text-[10px] text-primary hover:underline">
        ...
        <div className="p-6 bg-background border-t border-border space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm text-secondary pt-2 border-t border-border/50">
          ...
          >
            ...
            {submitting ? "Processing..." : "Create Advance Order"}
          </button>
        </div>
      </div>
    </div>
